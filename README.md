...
Optional manual analysis output:
- `v2/` playoff and season-analysis artifacts generated by `python3 scripts/generate_season_analysis.py`
...
- [`docs/PLAYOFF_DATA_SCHEMA.md`](docs/PLAYOFF_DATA_SCHEMA.md) - Canonical game rules and `data/v2/` contracts

## Manual Playoff Analysis

For playoff planning, structured season context, and later LLM prompting, generate the manual analysis layer:
...
This writes compact artifacts under `data/v2/` without changing the current display pipeline.
